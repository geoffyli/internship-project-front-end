...
<template>
    <div class="surface-0 flex justify-content-center">
        <div id="home" class="landing-wrapper overflow-hidden">
            <div style="background: linear-gradient(90deg, rgb(164, 131, 241) 20%, rgb(38, 172, 206) 70%)"
                class="py-1 px-3 mx-0 md:mx-0 lg:mx-0 lg:px-8 flex align-items-center justify-content-between relative lg:static mb-0">
                <span class="text-900 font-medium text-4xl line-height-4 mr-8 text-white">INTERNSHIP</span>
            </div>
            ...
            <div id="hero" class="flex flex-column pt-4 px-4 lg:px-8 overflow-hidden"
                ...
                <div class="flex justify-content-center md:justify-content-end">
                    <img src="/src/assets/images/welcome/screen-1.png" alt="Hero Image" class="w-9 md:w-auto" />
                </div>
            </div>
                ...
                <div class="grid justify-content-center">
                    ...
                    <div class="col-12 mt-8 mb-8 p-2 md:p-8"
                        ...
                        <div
                            ...
                            <img src="/src/assets/images/welcome/peak-logo.svg" class="mt-4" alt="Company logo" />
                        </div>
                    </div>
                </div>
            </div>
