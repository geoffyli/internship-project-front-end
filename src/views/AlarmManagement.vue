...
const addQuota = () => {
    ...
    if (name.value == null || quotaId.value == null || operator.value == null || threshold.value == null || level.value == null || cycle.value == null || name.value == '' || quotaId.value == '' || operator.value == '' || threshold.value == '' || level.value == '' || cycle.value == '') {
    ...
    <div class="grid">
        <div class = "col-6">
            <div class="card p-fluid">
                ...
                <DataTable :value="quotaTable" :paginator="true" class="p-datatable-gridlines"
                    :rows="8" dataKey="id" :rowHover="true" responsiveLayout="scroll" stripedRows>
        ...
        <div class="col-6">
            <div class="card p-fluid">
                ...
                <form>
                    ...
                    <div class="field">
                        <label for="cycle">Slience Cycle</label>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="grid p-fluid mt-3">
                    ...
                    <div class="field col-12 md:col-2">
                        <Button label="Delete" :disabled="selected === null ? true : selected.length === 0" disabled
                            class="p-button-danger mr-2 mb-2" @click="deleteAlarm" />
                    </div>
                </div>
                ...
                <DataTable v-model:selection="selected" :value="alarmTable" :paginator="true" class="p-datatable-gridlines"
                    ...
                    <Column header="Quota ID" style="min-width: 14rem">
                        <template #body="{ data }">
                            {{ data.quotaId }}
                        </template>
                    </Column>
                    <Column header="Quota Name" style="min-width: 14rem">
                        <template #body="{ data }">
                            {{ data.quota.name }}
                        </template>
                    </Column>
                    <Column header="Operator" style="min-width: 14rem">
                        <template #body="{ data }">
                            {{ data.operator }}
                        </template>
                    </Column>
                    <Column header="Threshold" style="min-width: 14rem">
                        <template #body="{ data }">
                            {{ data.threshold }}
                        </template>
                    </Column>
                    <Column header="Level" style="min-width: 14rem">
                        <template #body="{ data }">
                            {{ data.level }}
                        </template>
                    </Column>
                    <Column header="Cycle" style="min-width: 14rem">
                        <template #body="{ data }">
                            {{ data.cycle }}
                        </template>
                    </Column>
